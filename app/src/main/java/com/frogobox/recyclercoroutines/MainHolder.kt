...
class MainHolder(private val view: View) : RecyclerView.ViewHolder(view) {
    ...
    fun bindItem(data: MainData, listener: MainItemListener) {
        ...
        view.findViewById<TextView>(R.id.frogo_rv_list_type_11_tv_desc).text = data.age.toString()
        view.findViewById<TextView>(R.id.frogo_rv_list_type_11_tv_subtitle).text = data.name
